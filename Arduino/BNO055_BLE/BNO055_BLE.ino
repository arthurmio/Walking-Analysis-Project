...
BLECharacteristic YawBLE("0004", BLERead | BLENotify, BLE_BUFFER_SIZES);
BLECharacteristic PitchBLE("0005", BLERead | BLENotify, BLE_BUFFER_SIZES);
BLECharacteristic RollBLE("0006", BLERead | BLENotify, BLE_BUFFER_SIZES);
